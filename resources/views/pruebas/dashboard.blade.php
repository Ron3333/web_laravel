...
@section('content')
    ...
    @empty($age)
        <div class="bg-gray-100 p-2">La edad esta vacia</div>
    @endempty
    ...
    <section class="mb-8">
        ...
        <ul class="space-y-2">
            @foreach($courses as $course)
                <li @class(['p-3 rounded border','bg-yellow-50 border-green-200' => $course['premium'],'bg-white border-gray-200' => !$course['premium']
                ])>
    ...
    <section class="mb-8 border-t pt-4">
        ...
        @env('local')
            <div class="text-xs text-red-400 mt-4 italic">
